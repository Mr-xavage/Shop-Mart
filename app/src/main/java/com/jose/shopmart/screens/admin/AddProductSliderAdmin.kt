            ...
            Column(
                ...
                ExposedDropdownMenuBox(
                    ...
                    TextField(
                        ...
                        readOnly = true, textStyle = TextStyle(fontFamily = FontFamily.Default),
                    ...
                    ExposedDropdownMenu(
                        ...
                        DropdownMenuItem(onClick = {
                            ...
                            Text(text = "Best Seller", style = TextStyle(fontFamily = FontFamily.Default))
                        }
                        ...
                        DropdownMenuItem(onClick = {
                            ...
                            Text(text = "Mobile Phones", style = TextStyle(fontFamily = FontFamily.Default))
                        }
                        ...
                        DropdownMenuItem(onClick = {
                            ...
                            Text(text = "Tv", style = TextStyle(fontFamily = FontFamily.Default))
                        }
                        ...
                        DropdownMenuItem(onClick = {
                            ...
                            Text(text = "Earphones", style = TextStyle(fontFamily = FontFamily.Default))
                        }
                    }
                }
